  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <a href="utama.php" class="list-group-item list-group-item-action bg-light">Dashboard</a>
        ...
        <a href="login_detail.php" class="list-group-item list-group-item-action bg-light">User</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Welcome to Admin Page <?php echo $nama; ?></h1>
        <p>Disini untuk ....</p>
        <p>Semoga Sehat Selalu <3</p>
      </div>
    </div>
